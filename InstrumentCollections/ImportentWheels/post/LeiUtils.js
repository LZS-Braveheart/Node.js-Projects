...
/*
    处理post请求,处理表单(只有数据的提交)
    处理后的数据作为回调函数的参数
*/
exports.formPost1 = function(req,res,callback) {
...
/*
    ...
    处理后的数据作为回调函数的参数
*/
exports.formPost2 = function(req,res,callback) {
    //如果你的访问地址是这个，并且请求类型是post
    if (req.url == "/dopost" && req.method.toLowerCase() == "post") {
...
exports.formDatasPostSet=function(req,res,savePosition,callback){
        ...
        form.parse(req, function(err, fields, files) {
            ...
            var newpath = __dirname + "/"+savePosition+"/" + ttt + ran + extname;
